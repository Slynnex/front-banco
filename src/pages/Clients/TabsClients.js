...
import { Typography, MenuItem, Select,FormControl, InputLabel } from '@material-ui/core';
...
const TabsClients = ({handleClient,formClient,nip,amount,setAmount,setNip,formBeneficiarie,handleBeneficiarie}) => {
     ...
     <div className='containerHeader'>
      ...
      <AppBar position="static" color="default">
        ...
        >
          ...
          <Tab label="Guarantees" {...a11yProps(5)} disabled={type === 'mortgage' ?false :true}/>
        </Tabs>
      </AppBar>
